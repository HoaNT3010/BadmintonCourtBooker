...
namespace Application.Services.ConcreteClasses
{
    public class MoMoService : IMoMoService
    {
        ...
        public MoMoCreatePaymentResponse? CreateMoMoPaymentForRechargeTransaction(Transaction transaction)
        {
            string orderInfo = $"Customer '{transaction.CreatorId}' pay for booking time recharge transaction '{transaction.Id}'";
